...
public class Main {
    public static void main(String[] args) {
        ...
        healthyBurger.addHamburgerAddition1("Egg",4.3);
        healthyBurger.addHealthyAddition1("Avocado",0.7);
       ...
       db.addHamburgerAddition3("Should not do this", 50.53);
        ...
        System.out.println("total Deluce Burger price is " + db.itemizeHamburger());
